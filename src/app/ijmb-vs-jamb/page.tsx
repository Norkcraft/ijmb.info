...
export const metadata = makeMetadata('IJMB vs JAMB: Which is Better?', 'Compare IJMB and UTME pathways to decide the fastest route to 200-level admission.', '/ijmb-vs-jamb');
...
export default function Page() {
  return <><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(faqJsonLd(faqs)) }} /><PageTemplate title="IJMB vs JAMB: Which is Better?" intro="Compare IJMB and UTME pathways to decide the fastest route to 200-level admission." points={[    'Get step-by-step support from application to admission letter.',
