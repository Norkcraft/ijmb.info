...
export const metadata = makeMetadata('IJMB Registration Guide', 'Complete IJMB registration online with verified guidance, preferred centre selection, and fast admission processing.', '/ijmb-registration');
...
export default function Page() {
  return <><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(faqJsonLd(faqs)) }} /><PageTemplate title="IJMB Registration Guide" intro="Complete IJMB registration online with verified guidance, preferred centre selection, and fast admission processing." points={[    'Get step-by-step support from application to admission letter.',
